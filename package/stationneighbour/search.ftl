...
<head>
  ...
  <link href="../stationneighbour/css/around.css" rel="stylesheet"/>
  ...
  <style type="text/css">
    ...
    .undefinedPoint {
      ...
      background: url("../stationneighbour/img/undefinedPoint.png") no-repeat !important;
...
<body>
<header id="header">
  <a href="/getNeighbourDetailByStationId.html?stationId=${stationId}&type=${type}&neighbourId=${stationNeighbourDto.getId()}"
...
<div class="position-relative">
  <div class="container">
    <div class="input-container">
      ...
      <div class="input clearfix">
        <span class="end"></span>
        <input id="end-input" type="text" placeholder="在此输入终点" value="${stationNeighbourDto.getAddress()}">
      </div>
    </div>
  </div>
